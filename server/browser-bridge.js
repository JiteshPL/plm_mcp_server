...
export function attachBrowserBridge(
    httpServer
) {
    ...
    ws.on("message", raw => {
        ...
        try {
            ...
            if (
                ...
                if (
                    mcpServerSocket?.readyState === 1
                ) {

                    mcpServerSocket.send(
                        JSON.stringify(
                            message
                        )
                    );
...
export function sendActionsToBrowser(
    actions
) {
