export const TOOL_DEFINITIONS = [
  ...
  { name: "generate_exploded_view", description: "Explodes or collapses assembly components.", inputSchema: { type: "object", properties: { explosionFactor: { type: "number", description: "0.0 to 2.0" } }, required: ["explosionFactor"] } },
